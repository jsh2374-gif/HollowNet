...
| Sitting Room | `HNA-26-ANM-006` Spiders — Installed | **Confirmed local continuous effect:** two projectors autoplay looping media; one continuously running 120 V motor and crank arm raise and lower six articulated spiders on monofilament at different times and speeds | Keep completely local; no room controller is needed. Document projector/media-player models, motor rating and shared/separate power switching. Add routine inspection of the crank, attachment points and monofilament. |
